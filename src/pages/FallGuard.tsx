  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
        <div className="bg-primary p-5 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center justify-between w-full">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
                <AlertTriangle size={20} className="text-white" />
              </div>
              <h1 className="text-white font-semibold text-xl">FallGuard</h1>
            </div>
        ...
        <div className="p-5 grid gap-4 lg:grid-cols-2">
          <div className="rounded-xl bg-red-600/95 p-4 text-white lg:col-span-2">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <div>
                ...
                <div className="text-sm text-white/90">
                  SOS darurat dikirim. Hubungi kontak darurat dan pantau lokasi
                  secara real time.
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 justify-between flex flex-col">
            <div>
            ...
            <div className="space-y-3 lg:flex lg:flex-col lg:justify-between">
              <button className="w-full bg-red-600 text-white py-3 rounded-lg font-semibold shadow">
          ...
          <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Pelacakan darurat aktif</p>
              </div>
